...
func TestRun(t *testing.T) {
	...
	snapshot1[cache.ClusterType] = []byte(`[{"name":"local_service","type":3,"eds_cluster_config":{"eds_config":{"ConfigSourceSpecifier":{"Ads":{}}},"service_name":"local_service"},"connect_timeout":5000000000,"health_checks":[{"timeout":{"seconds":1},"interval":{"seconds":1},"unhealthy_threshold":{"value":5},"healthy_threshold":{"value":6},"HealthChecker":{"HttpHealthCheck":{"path":"/status"}}}],"tls_context":{},"LbConfig":null},{"name":"local_service_1","type":3,"eds_cluster_config":{"eds_config":{"ConfigSourceSpecifier":{"Ads":{}}},"service_name":"local_service_1"},"connect_timeout":5000000000,"health_checks":[{"timeout":{"seconds":1},"interval":{"seconds":1},"unhealthy_threshold":{"value":5},"healthy_threshold":{"value":6},"HealthChecker":{"HttpHealthCheck":{"path":"/status"}}}],"tls_context":{},"LbConfig":null}]`)
	...
	snapshot2[cache.ClusterType] = []byte(`[{"name":"local_service","type":3,"eds_cluster_config":{"eds_config":{"ConfigSourceSpecifier":{"Ads":{}}},"service_name":"local_service"},"connect_timeout":5000000000,"health_checks":[{"timeout":{"seconds":1},"interval":{"seconds":1},"unhealthy_threshold":{"value":5},"healthy_threshold":{"value":6},"HealthChecker":{"HttpHealthCheck":{"path":"/status"}}}],"tls_context":{},"LbConfig":null}]`)
	...
	snapshot3[cache.ClusterType] = []byte(`[{"name":"local_service","type":3,"eds_cluster_config":{"eds_config":{"ConfigSourceSpecifier":{"Ads":{}}},"service_name":"local_service"},"connect_timeout":5000000000,"health_checks":[{"timeout":{"seconds":1},"interval":{"seconds":1},"unhealthy_threshold":{"value":5},"healthy_threshold":{"value":6},"HealthChecker":{"HttpHealthCheck":{"path":"/status"}}}],"tls_context":{},"LbConfig":null}]`)
	...
	snapshot4[cache.ClusterType] = []byte(`[{"name":"local_service","type":3,"eds_cluster_config":{"eds_config":{"ConfigSourceSpecifier":{"Ads":{}}},"service_name":"local_service"},"connect_timeout":5000000000,"health_checks":[{"timeout":{"seconds":1},"interval":{"seconds":1},"unhealthy_threshold":{"value":5},"healthy_threshold":{"value":6},"HealthChecker":{"HttpHealthCheck":{"path":"/status"}}}],"tls_context":{},"LbConfig":null}]`)
	...
	config := cache.NewSnapshotCache(true, Hasher{}, DefaultCacheLogger{})
